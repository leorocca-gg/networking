...
module "net-firewall-policy" {
  ...
  factories_config = {
    ...
    egress_rules_file_path  = "${var.factories_config.firewall.policy_rules}/hierarchical-egress-rules.yaml"
    ingress_rules_file_path = "${var.factories_config.firewall.policy_rules}/hierarchical-ingress-rules.yaml"
  }
